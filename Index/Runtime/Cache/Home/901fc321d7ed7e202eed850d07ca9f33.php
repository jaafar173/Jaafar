...
<body role="document">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
           ...
           <!--  <li><a href="/user/login">用户登陆</a></li> -->
          </ul>
        </div>
      </div>
    </div> 
    ...
    <div class="container">
      ...
      <div class="blog-header">
        ...
        <p class="lead blog-description"><?php echo ($article["description"]); ?></p>
      </div>
        ...
        <div class="col-sm-8 blog-main">
          <div class="blog-post">
           <!--  <h2 class="blog-post-title"><?php echo ($article["title"]); ?></h2> -->
            <p class="blog-post-meta"><?php echo ($article["addtime"]); ?><a href="#">Mark</a></p>
