 ...
 * @date 2013/4/17
 */
class AjaxUploadController extends CommonController{
    //global 
    ...
    public function __construct($form_name, $file_size) {
        ...
        $this->upload_dir = __ROOT__.'Public/temp';
